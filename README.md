...
Data engineering step-by-step process on how to use AWS tools to get data from an API, send them to an S3 Bucket using a Lambda function, do ETL processes with a Glue Job and send to a PostgreSQL database with an Upsert approach.
